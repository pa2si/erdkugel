  ...
  return (
    <main className=" pt-20 container mx-auto mt-1 mb-8">
      ...
      <div className={styles.privacy}>
        ...
        <p>
          Unsere Domain ist bei dem Anbieter DomainFactory registriert. Anbieter
          ist die DomainFactory GmbH, c/o WeWork, Neuturmstraße 5, 80331 München
          (nachfolgend DomainFactory).
        </p>
        <p>
          Details entnehmen Sie der Datenschutzerkl&auml;rung von DomainFactory:{' '}
          <a
        ...
        <p>
          Die technische Plattform und das Hosting unserer Website erfolgt durch
          den Anbieter Vercel, Inc. Anbieter ist die Vercel, Inc., 340 S Lemon
          Ave #4133, Walnut, CA 91789, USA (nachfolgend Vercel). Da Vercel
          seinen Sitz in den USA hat, sind zusätzliche Datenschutzmaßnahmen
          ergriffen worden, um Ihre personenbezogenen Daten zu schützen. Wir
          haben mit Vercel einen Datenverarbeitungsvertrag abgeschlossen, der
          die Standards der DSGVO berücksichtigt.
        </p>
        <p>
        ...
        <p>
          Die Verwendung von DomainFactory und Vercel erfolgt auf Grundlage von
          Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an
          einer möglichst zuverlässigen Registrierung unserer Domain sowie
          Darstellung und technischer Umsetzung unserer Website. Sofern eine

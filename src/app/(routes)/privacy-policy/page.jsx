      ...
      <article className="mt-4">
        <address className={` text-center ${styles.privacy}`}>
          ...
          <p>
            ...
            Vercel seinen Sitz in den USA hat, sind zusätzliche
            Datenschutzmaßnahmen ergriffen worden, um Ihre personenbezogenen
            Daten zu schützen. Wir haben mit Vercel einen
